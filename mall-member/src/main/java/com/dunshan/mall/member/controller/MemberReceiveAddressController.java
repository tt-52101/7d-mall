...
import com.dunshan.mall.member.service.UmsMemberReceiveAddressService;
...
public class MemberReceiveAddressController {
    ...
    @ResponseBody
    public CommonResult<UmsMemberReceiveAddress> getItem(@PathVariable Long id,@PathVariable Long userId) {
        UmsMemberReceiveAddress address = memberReceiveAddressService.getItem(id,userId);
